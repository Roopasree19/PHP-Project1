...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE contact set id='" . $_POST['id'] . "', name='" . $_POST['name'] . "', email='" . $_POST['email'] . "', subject='" . $_POST['subject'] . "' ,message='" . $_POST['message'] . "' WHERE id='" . $_POST['id'] . "'");
...
<input type="hidden" name="id" class="txtField" value="<?php echo $row['id']; ?>">
					...
					<input type="text" class="text" name="name" value="<?php echo $row['name']; ?>" placeholder="Name" required >
					<input type="email" class="text" name="email" value="<?php echo $row['email']; ?>" placeholder="Email" required>
					<input type="text" class="text" name="subject" value="<?php echo $row['subject']; ?>" placeholder="Subject" required>
				 </div>
				 <div class="col-md-6 contact-right">
						 <input type="text" placeholder="Message" name="message" value="<?php echo $row['message']; ?>">
